...
|---|---|---|---|
| [`vector-regnum`](https://github.com/iankengott/vector-regnum) | Active NeoForge 1.21.1 magic mod; priorities 1-20a have coherent alpha passes and `ROADMAP.md` controls current work | `/home/iank/Desktop/my mods/mods-editing/vector-regnum` | Active |

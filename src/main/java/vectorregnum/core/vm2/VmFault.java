...
public record VmFault(Code code, String message, SourceLocation source, int instructionPointer) {
    ...
    public enum Code {
        ...
        VARIABLE_LIMIT, VARIABLE_NOT_FOUND, VARIABLE_TYPE_MISMATCH,
        ITERATOR_LIMIT, ITERATOR_NOT_FOUND, ITERATOR_STEP_LIMIT,
        BRANCH_LIMIT, DUPLICATE_BRANCH, UNJOINED_BRANCH,
        WATCHER_LIMIT, SIGNAL_LIMIT, OUTPUT_LIMIT, OUTPUT_TOO_LARGE
    }
}

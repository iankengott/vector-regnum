...
public final class SemanticSchema {
    private static final Set<SemanticOpcode> NO_OPERANDS = Set.of(
            ...
            SemanticOpcode.ELEMENT_FIRE, SemanticOpcode.ELEMENT_ICE,
            SemanticOpcode.ELEMENT_ARCANE, SemanticOpcode.ELEMENT_VOID,
            SemanticOpcode.ELEMENT_WATER, SemanticOpcode.ELEMENT_AIR,
            SemanticOpcode.ELEMENT_EARTH, SemanticOpcode.ELEMENT_LIGHTNING,
            SemanticOpcode.ELEMENT_TIME, SemanticOpcode.ELEMENT_SPACE,
            SemanticOpcode.ELEMENT_LIGHT, SemanticOpcode.ELEMENT_DARK,
            SemanticOpcode.ELEMENT_NATURE, SemanticOpcode.ELEMENT_SOUND,
